...
text_model = genai.GenerativeModel('gemini-1.5-flash')  # Or 'gemini-pro-vision' if you need image input
        ...
        async for message in websocket:
            ...
            try:
                ...
                if not user_message:
                    ...
                    #### Syptom Extraction #####
                    async def extract_symptoms(user_message):
                    ...
                    async def classify_medical_speciality(user_message):
                        # classification1 = zero_shot_classification_batch([user_message])
                        # print("\n🩺 Medical Speciality Classification:", classification1)
                        pass
                    
                    ai_result = text_model.generate_content(system_prompt+message, stream=True)
